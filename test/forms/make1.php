        ...
        <div class="row">
          ...
          <div class="col-md-4 form-group mt-3">
            <select name="clinic" id="clinic" class="form-select">
              ...
              <option value="Cosmetic Dermatology and Laser">Cosmetic Dermatology and Laser</option>
              <option value="Pediatrics and New Born">Pediatrics and New Born</option>
              ...
              <option value="Dental and periodontal medicine and surgery">Dental and periodontal medicine and surgery</option>
