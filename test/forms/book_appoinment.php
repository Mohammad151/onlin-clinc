...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['name'])) {
  ...
  $sql = "INSERT INTO appointment(Fname,Realitive_Realation,phone,patient_age,message_sent,clinic,email) VALUES ('$name','$Relative_Relation','$phone','$patient_age','$message','$id','" . $_SESSION['Email'] . "')";
